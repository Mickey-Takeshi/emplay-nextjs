...
export default function ShareButtons({ slug, title }: { slug: string; title: string }) {
  ...
  return (
    <div className="share-buttons" aria-label="この記事をシェア">
      <span className="share-buttons-label">この記事をシェア</span>
      <div className="share-buttons-list">
        ...
        <button
          ...
          aria-label="URLをコピー"
        >
          <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" width="18" height="18"><path d="M10 13a5 5 0 007.54.54l3-3a5 5 0 00-7.07-7.07l-1.72 1.71"/><path d="M14 11a5 5 0 00-7.54-.54l-3 3a5 5 0 007.07 7.07l1.71-1.71"/></svg>
