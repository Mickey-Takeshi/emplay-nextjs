...
const OLD_BLOG_REDIRECTS = [
  ...
  { from: 'generative-ai-marketing', to: 'generative-ai-marketing-guide' },
  { from: 'ai-introduction-guide-sme', to: 'sme-ai-introduction-guide' },
  { from: 'google-ads-guide', to: 'google-ads-basics-guide' },
  { from: 'smb-marketing-strategy-guide', to: 'smb-web-marketing-strategy-50man' },
  { from: 'lp-improvement-checklist', to: 'lp-improvement-checklist-50' },
  { from: 'review-marketing-guide', to: 'google-review-increase-guide' },
  { from: 'ma-guide', to: 'marketing-automation-guide' },
  { from: 'ma-marketing-automation-guide', to: 'marketing-automation-guide' },
  { from: 'electronic-bookkeeping-guide', to: 'paperless-implementation-guide' },
  { from: 'web-advertising-types-comparison', to: 'web-ads-types-comparison' },
  { from: 'dx-sme-guide', to: 'sme-dx-promotion-guide' },
  { from: 'security-basics-for-business', to: 'sme-security-basics-guide' },
  { from: 'security-basics-guide', to: 'sme-security-basics-guide' },
  { from: 'ab-test-guide', to: 'lp-ab-test-guide' },
  { from: 'product-photography-guide', to: 'ec-sales-improvement-guide' },
  { from: 'seo-basics-guide', to: 'seo-technical-optimization-guide' },
  { from: 'seo-technical-guide', to: 'seo-technical-optimization-guide' },
  { from: 'search-console-guide', to: 'google-search-console-guide' },
  { from: 'blog-management-guide', to: 'owned-media-startup' },
  { from: 'sora-video-ai-guide', to: 'video-ai-guide' },
